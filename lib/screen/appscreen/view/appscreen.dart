        ...
        children: [
          Container(
            ...
            child: ListView(
              children: [
                ListTile(
                  leading: Text("Social Media App",style: TextStyle(fontSize: 18)),
                  trailing: Icon(Icons.arrow_forward,color: Colors.black),
                ),
                Container(height:220,child: ListView.builder(itemBuilder: (context, index) => appAdBox(appImage1[index],appLogo1[index],appName1[index]),itemCount: 3,shrinkWrap: true,physics: BouncingScrollPhysics(),scrollDirection: Axis.horizontal)),
                Container(height: 170,width: double.infinity,child: ListView.builder(itemBuilder: (context, index) => appbox(appLogo2[index],appName2[index]),itemCount: 3,scrollDirection: Axis.horizontal,shrinkWrap: true),),
                Container(height:220,child: ListView.builder(itemBuilder: (context, index) => appAdBox(appImage2[index],appLogo2[index],appName2[index]),itemCount: 3,shrinkWrap: true,physics: BouncingScrollPhysics(),scrollDirection: Axis.horizontal)),
          ...
          child: Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  SizedBox(height: 5,),
                  Text("${name}",style: TextStyle(fontSize: 15,letterSpacing: 1)),
                  Text("Social Media app",style: TextStyle(fontSize: 10,letterSpacing: 1)),
                  Text("4.2* Rating",style: TextStyle(fontSize: 9,letterSpacing: 1)),
                ],
              ),
            ],
          ),
